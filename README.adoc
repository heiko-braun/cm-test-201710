= Externalized Configuration - WildFly Swarm Booster
...
----
$ git clone git@github.com:heiko-braun/cm-test-201710
...
[source,bash,options="nowrap",subs="attributes+"]
----
$ oc get route booster-configmap-wildfly-swarm -o jsonpath={$.spec.host}

booster-configmap-wildfly-swarm-MY_PROJECT_NAME.LOCAL_OPENSHIFT_HOSTNAME
----
...
[source,bash,options="nowrap",subs="attributes+"]
----
$ curl http://booster-configmap-wildfly-swarm-MY_PROJECT_NAME.LOCAL_OPENSHIFT_HOSTNAME/api/greeting
{"content":"Hello World from a ConfigMap!"}

$ curl http://booster-configmap-wildfly-swarm-MY_PROJECT_NAME.LOCAL_OPENSHIFT_HOSTNAME/api/greeting?name=Sarah
